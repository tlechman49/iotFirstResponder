...
static int light_sleep(int argc, char **argv)
{
    ...
    fflush(stdout);
    //!TL - There was a disagree here preventing compilation because uart driver does not contain this function
    // This prevents the UART from passing user feedback before going to sleep
